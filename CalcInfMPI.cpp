...
int main(int argc, char** argv){
    ...
    int global_PrecioAccMes[12];
    int global_CantAccMes[12];

    MPI_Allreduce(PrecioAccMes, global_PrecioAccMes, 12, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    MPI_Allreduce(CantAccMes, global_CantAccMes, 12, MPI_INT, MPI_SUM, MPI_COMM_WORLD);

    memcpy(PrecioAccMes, global_PrecioAccMes, sizeof(PrecioAccMes));
    memcpy(CantAccMes, global_CantAccMes, sizeof(CantAccMes));
